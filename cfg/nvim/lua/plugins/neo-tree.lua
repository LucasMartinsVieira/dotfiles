...
return {
  ...
  keys = {
    { "<space>e", "<CMD>NeoTreeShowToggle<CR>", desc = "[E]xplorer" },
  },
  requires = {
    ...
    require("neo-tree").setup({
      ...
      default_component_configs = {
        ...
        indent = {
          ...
          -- indent guides
          with_markers = true,
          indent_marker = icons.ui.Separator,
          last_indent_marker = "└",
        ...
        icon = {
          folder_closed = icons.documents.default,
          folder_open = icons.documents.open,
          folder_empty = icons.documents.empty,
